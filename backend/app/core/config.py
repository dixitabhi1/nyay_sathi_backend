...
class Settings(BaseSettings):
    ...
    database_probe_timeout_seconds: float = Field(default=6.0, alias="DATABASE_PROBE_TIMEOUT_SECONDS")
    prefer_local_app_db_on_space: bool = Field(default=False, alias="PREFER_LOCAL_APP_DB_ON_SPACE")
    allow_remote_app_db_on_space: bool = Field(default=True, alias="ALLOW_REMOTE_APP_DB_ON_SPACE")
    ...
    query_embedding_cache_size: int = Field(default=256, alias="QUERY_EMBEDDING_CACHE_SIZE")
    retrieval_result_cache_size: int = Field(default=128, alias="RETRIEVAL_RESULT_CACHE_SIZE")
    scope_assessment_cache_size: int = Field(default=128, alias="SCOPE_ASSESSMENT_CACHE_SIZE")
